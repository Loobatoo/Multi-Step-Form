  ...
  return (
    <div className="Form">
      <div className="Catch-mood">
        <Mood Icon={<FaFrown/>} Text="Triste" name="mood" Act={Act1} iconType=""/>
        <Mood Icon={<FaMeh />} Text="Indiferente" name="mood" Act={Act1} iconType=""/>
        <Mood Icon={<FaGrin />} Text="Feliz" name="mood" Act={Act1} iconType=""/>
